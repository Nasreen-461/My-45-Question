...
*/
let myplaces = ["Karachi", "UK", "Larkana", "Sukkur", "Hyderabad", "Quetta"];
console.log(myplaces);
//making a copy of an array slice
let copyOfArry = myplaces.slice();
let sortedArry = copyOfArry.sort();
console.log(sortedArry);
//printing oringinal array
//console.log(myplaces); 
//reversing orginal array
//first we have make a copy of original array reverse
let reverseOfArrary = myplaces.reverse();
console.log(reverseOfArrary);
let againReverse = reverseOfArrary.reverse();
